  ...
  return (
    ...
    <div className='container d-flex my-5 align-items-center pre-BriefAbout-text '>
      <div className='BriefAbout-text'>
        ...
        <h2 className='fw-bold fs-1'>ASAS</h2>
        <p>ASAS is a leading platform for Engineering Design and connects engineering offices and customers, the expertise and experience that our partners bring, and we are known for staying inside of estimated budgets. If you’re in need of some remodelling done to your home or built a house from scratch, we’re sure to surpass your expectations!</p>
