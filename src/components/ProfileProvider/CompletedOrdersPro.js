...
const CompletedOrdersPro = ({UserId}) => {
  ...
  console.log(UserId);
    ...
    const fetchOrders = async () => {
      console.log(UserId);
      try {
        const response = await axios.get(`http://localhost:8000/OfficeCompletedOrders/${UserId}`);
  ...
  return (
    <>
      <div className="Main Sidebar my-3 border rounded-4">
        <h2 className="mt-3 p-3 ms-3">CompletedOrders</h2>
